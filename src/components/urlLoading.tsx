          ...
          >
            <div className="flex flex-col md:flex-row gap-5">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="bg-gray-300 h-4 w-24 rounded mt-2"></div>
                <div className="bg-gray-300 h-4 w-40 rounded mt-1"></div>
                <div className="bg-gray-300 h-3 w-20 rounded mt-2"></div>
              </div>
            </div>
