...
import shortlyLogo from "../../public/ShortlyWhite.webp";
...
export function SecondFooter() {
  return (
    <section className="bg-VeryDarkViolet flex flex-col md:flex-row text-white md:px-10 lg:px-20 justify-between pt-9 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:w-[76%] lg:w-[70%]">
        ...
        />
        <div className="self-center mt-3 md:mt-1 md:self-start">
